...
local TRACKED_DEBUFF_CATALOG = {
  ...
  ["faerie fire (feral)"] = { name = "Faerie Fire (Feral)", class = "DRUID", duration = 40 },
  ["hibernate"] = { name = "Hibernate", class = "DRUID", duration = 20 },
  ...
  -- MAGE
  ["blast wave"] = { name = "Blast Wave", class = "MAGE", duration = 6 },
  ...
  ["holy fire"] = { name = "Holy Fire", class = "PRIEST", duration = 10 },
  ["mind flay"] = { name = "Mind Flay", class = "PRIEST", duration = 3 },
  ...
  -- ROGUE
  ["blind"] = { name = "Blind", class = "ROGUE", duration = 10 },
  ["cheap shot"] = { name = "Cheap Shot", class = "ROGUE", comboDurations = {4, 4, 4, 4, 4} },
  ...
  ["frostbrand weapon"] = { name = "Frostbrand Weapon", class = "SHAMAN", duration = 8 },
  ...
  ["disarm"] = { name = "Disarm", class = "WARRIOR", duration = 10 },
  ["hamstring"] = { name = "Hamstring", class = "WARRIOR", duration = 15 },
  ["intercept"] = { name = "Intercept", class = "WARRIOR", duration = 3 },
